...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-phonegap-plugin-barcodescanner/node_modules/phonegap-plugin-barcodescanner/spec/helper/cordova.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-phonegap-plugin-barcodescanner/node_modules/phonegap-plugin-barcodescanner/spec/helper/cordova.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-phonegap-plugin-barcodescanner/node_modules/phonegap-plugin-barcodescanner/spec/helper/</a> &#187; cordova.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">/* global cordova:true */
&nbsp;
/*!
 * Module dependencies.
 */
...
&nbsp;
    require: function(moduleId) {
        ...
        <span class="missing-if-branch" title="else path not taken" >E</span>if (!cordova.required[moduleId]) {
            cordova.required[moduleId] = <span class="fstat-no" title="function not covered" >function() {</span>};
        }
...
<span class="cstat-no" title="statement not covered" >        return cordova.required[moduleId].apply(this, arguments);</span>
    };
}
&nbsp;
&nbsp;</pre></td></tr>
